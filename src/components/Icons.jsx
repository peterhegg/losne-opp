...
export const IconFlame = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="var(--ember)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconDag = ({ active }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke={active ? '#fff' : 'var(--ink-soft)'} strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
